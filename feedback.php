                ...
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form name="sentMessage" id="feedbackForm" action="actions/addComment.php" method="post" novalidate>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Course</label>
                                <input type="text" class="form-control" placeholder="Course" name="course" id="course" required data-validation-required-message="Please enter your course." value="<?php echo $_GET["course"]; ?>">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
