    ...
    <br>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <p>UCL Computer science department needs your feednback to improve. Please help us by completing the forms below.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form name="sentMessage" id="contactForm" action="/actions/addComment.php" method="post" novalidate>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="tel" class="form-control" placeholder="Phone Number" name="phonenumber" id="phone" required data-validation-required-message="Please enter your phone number.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h3>Location</h3>
                        <p>Gower St <br> Kings Cross
                            <br>London WC1E 6BT</p>
                    </div>
                    <div class="footer-col col-md-4">
